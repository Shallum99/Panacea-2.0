...
from app.api.endpoints import messages, resumes, job_descriptions, users, test, auth, resume_tailor, resume_editor, applications, auto_apply, admin, billing, profile, job_search, chat
...
api_router.include_router(resume_editor.router, prefix="/resume-editor", tags=["resume-editor"])